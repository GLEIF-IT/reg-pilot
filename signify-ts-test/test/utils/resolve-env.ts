...
export function resolveEnvironmentMultipleAid(
  input?: TestEnvironmentPreset,
): TestEnvironment {
  const preset = input ?? process.env.TEST_ENVIRONMENT ?? "docker";
  const providedSecrets =
    process.env.SIGNIFY_SECRETS_MULTI_AID ||
    "D_PbQb0ESFGQgK-kDWd3f,BTaq43FG3G34GGSQJp6mb,BRFHnuf98vnih8hfinf4g,nf98hUHUy8Vt5tvdyaYV7;D_PbQb01zuzQgK-kDWjqy,BTaqgh1eeOjXO5iQJp6mb,Akv4TFoiYeHNqzj3N8gEg,CbII3tno87wn3uGBP12qm;D_PbQfw4fvFEf4-fesefF,NUH98hbsuhd8hdua8hnfa,ANud8hnahdaNUnfsanofN,defh7b7g7gfaBuf83bf0f";
  let env;
  switch (preset) {
    case "docker":
      env = {
